...
public class Pong extends Canvas implements KeyListener, Runnable {
	...
	public Pong() {
		...
		ball = new Ball(15, 100, 10, 10, Color.blue, 2, 1);
		leftPaddle = new Paddle(20, 200, 10, 40, Color.orange, 5);
		rightPaddle = new Paddle(760, 200, 10, 40, Color.orange, 5);
		keys = new boolean[4];
		leftscore = 0;
		rightscore = 0;
	...
	public void paint(Graphics window) {
		...
		graphToBack.drawString("Right Score "+ rightscore, 250, 515);
		graphToBack.drawString("Left Score "+ leftscore, 350, 515);
		...
		if(ball.didCollideBottom(ball)) ball.setYSpeed(-ball.getYSpeed());
		if(ball.didCollideTop(ball)) ball.setYSpeed(-ball.getYSpeed());
